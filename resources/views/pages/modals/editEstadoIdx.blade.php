@foreach($proximasSesiones as $estado)
<!-- Editar Estado -->
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        ...
                                        <p class="text-muted mb-0">
                                            ...
                                            {{ \Carbon\Carbon::parse($estado->hora_inicio)->format('H:i') }} a {{ \Carbon\Carbon::parse($estado->hora_fin)->format('H:i') }}
                                        </p>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        ...
                                        <br>
                                        <small class="text-muted">Próxima sesión</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <form action="{{ route('estado.updateIdx', $estado->id_estado) }}" method="POST" id="formEditEstado{{ $estado->id_estado }}">
                    @csrf
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="d-flex align-items-center justify-content-center h-100">
                                <div class="text-center">
                                    <i class="ri-calendar-check-line fs-24 text-success mb-2"></i>
                                    <p class="text-muted small mb-0">Próxima sesión programada</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-success">
                        ...
                        <strong>Próxima Sesión:</strong> Los cambios se aplicarán a esta sesión próxima.
                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <button type="submit" class="btn btn-success" id="guardarBtnEditEstado{{ $estado->id_estado }}">
