    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('reuniones.updateCal', $reunion->id_reunion) }}" method="POST" id="formEditReunion{{ $reunion->id_reunion }}">
                    @csrf
                    ...
                    <div class="modal-footer">
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <button type="submit" class="btn btn-info" id="guardarBtnEditReunion{{ $reunion->id_reunion }}">
