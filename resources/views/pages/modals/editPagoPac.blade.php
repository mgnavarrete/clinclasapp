            ...
            <div class="modal-body">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 text-end">
                                        ...
                                        @endphp
                                        <span class="badge {{ $badgeClass }} fs-12 mb-2">
                                            <i class="ri-bookmark-line me-1"></i>{{ ucfirst($pago->estado) }}
                                        </span>
                                        <br>
                                        <a href="{{ route('pagos.show', $pago->id_pago) }}" class="btn btn-sm btn-outline-primary">
                ...
                <form action="{{ route('pago.updatePac', $pago->id_pago) }}" method="POST" id="formEditPago{{ $pago->id_pago }}">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="d-flex align-items-center justify-content-center h-100">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted small mb-0">Gestión desde paciente</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-warning">
                        ...
                        <strong>Información:</strong> El cambio de estado se aplicará inmediatamente al registro de pago.
                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <button type="submit" class="btn btn-warning" id="guardarBtnEditPago{{ $pago->id_pago }}">
