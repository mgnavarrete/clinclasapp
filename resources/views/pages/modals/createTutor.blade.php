...
<script>
    document.getElementById('createTutorForm').addEventListener('submit', function() {
             // Ocultar el botón de guardar
             document.getElementById('guardarBtnCreateTutor').classList.add('d-none');
             // Mostrar el spinner
             document.getElementById('spinnerCreateTutor').classList.remove('d-none');
         });
 </script>