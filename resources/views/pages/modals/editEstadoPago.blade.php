            ...
            <div class="modal-body">
                ...
                <form action="{{ route('estado.updatePago', ['id_estado' => $estado->id_estado, 'id_pago' => $pago->id_pago]) }}" method="POST" id="formEditEstado{{ $estado->id_estado }}">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <strong>Pagos:</strong> Los cambios afectarán el cálculo y estado del pago asociado.
                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <button type="submit" class="btn btn-warning" id="guardarBtnEditEstado{{ $estado->id_estado }}">
