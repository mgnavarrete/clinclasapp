    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <p class="fw-semibold mb-2 d-flex align-items-center">
                                            ...
                                            Nueva Reunión desde Calendario
                                        </p>
                                        <p class="text-muted mb-0">
                                            <i class="ri-user-line me-1"></i>Selecciona el paciente y programa la reunión
                                        </p>
                                    </div>
                ...
                <form action="{{ route('calendario.createReunion') }}" method="POST" id="agendarReunionForm">
                    @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="paciente_reunion" class="form-label text-default">
                            <i class="ri-user-line me-1"></i>Paciente
                        </label>
                        <select class="form-select form-select-lg bg-outline-primary" id="paciente_reunion" name="paciente_reunion" required>
                ...
                <div class="alert alert-info">
                    ...
                    <strong>Información:</strong> La reunión será agendada para el paciente seleccionado en la fecha y horario especificados.
                </div>
