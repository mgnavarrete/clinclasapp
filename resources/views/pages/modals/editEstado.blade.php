    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('estado.update', $estado->id_estado) }}" method="POST" id="formEditEstado{{ $estado->id_estado }}">
                    @csrf
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="d-flex align-items-center justify-content-center h-100">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted small mb-0">Selecciona el estado actual de la sesión</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Información:</strong> Los cambios se aplicarán inmediatamente al estado de la sesión.
                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <button type="submit" class="btn btn-primary" id="guardarBtnEditEstado{{ $estado->id_estado }}">
