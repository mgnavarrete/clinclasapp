    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 text-end">
                                        ...
                                        <br>
                                        <small class="text-muted">Próxima reunión</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <form action="{{ route('reuniones.updateIdx', $reunion->id_reunion) }}" method="POST" id="formEditReunion{{ $reunion->id_reunion }}">
                    @csrf
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="d-flex align-items-center justify-content-center h-100">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted small mb-0">Próxima reunión</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-success">
                        ...
                        <strong>Próxima Reunión:</strong> Los cambios se aplicarán a esta reunión programada.
                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <button type="submit" class="btn btn-success" id="guardarBtnEditReunion{{ $reunion->id_reunion }}">
